...
reimplement or copy the same basic makefile when setting up a new repo.  This
repo is intended to be a good starting point for those projects, replacing the
tedious setup process with a simple git pull.
